route_info = {
    ...
    "Block": [65,73,77,88,96,77,105,114,123,132,141,22,16,9,2,16,22,31,39,48,57,0],
    "Name": ["Glenbury",
             "Dormont", 
             "Mt. Lebanon",
             "Poplar",
    ...
    "Meters to next": [500,900,600,2686.6,600,2700,715,952,540,450,450,1859,1050,850,700,800,1200,1150,400,396,450,100]
}
