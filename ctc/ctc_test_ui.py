...
tk.Label(dispatcher_frame, text="Suggested Speed (mph)",font=label_font).grid(row=3,column=0,sticky='w',padx=5,pady=10)
tk.Label(dispatcher_frame, text="Authority (yards)",font=label_font).grid(row=4,column=0,sticky='w',padx=5,pady=10)
tk.Label(dispatcher_frame, text="Station",font=label_font).grid(row=5,column=0,sticky='w',padx=5,pady=10)
tk.Label(dispatcher_frame, text="Arrival Time",font=label_font).grid(row=6,column=0,sticky='w',padx=5,pady=10)
...
station_destination_box = ttk.Combobox(track_model_frame,values=["1","2","3"],font=label_font)
station_destination_box.grid(row=2,column=4,padx=5,pady=5,sticky='ew')
