...
class CTCUI:
    ...
    def setup_ui(self):
        ...
        self.maint_line_box1 = ttk.Combobox(switch_frame, values=["Green"], font=input_font)
        self.maint_switch_box = ttk.Combobox(switch_frame, values=["13-1" ,"13-2","28-29","28-150","57-0","57-58","63-62","63-151","77-78","77-101","85-86","85-100"], font=input_font)
        ...
        tk.Label(block_frame, text="Enter a Block", font=label_font, bg="lightyellow").grid(row=1, column=0, sticky='w', padx=5, pady=5)
        self.maint_line_box2 = ttk.Combobox(block_frame, values=["Green"], font=input_font)
        self.maint_block_box = ttk.Entry(block_frame, font=input_font)
